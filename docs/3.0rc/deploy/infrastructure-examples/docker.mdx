...
For example, when release `3.0.0` is published:
...
2.  These images are tagged with the full description, for example: `prefect:3.0.0-python3.12` and `prefect:3.0.0-python3.12-conda`.
3.  For users that want more specific pins, these images are also tagged with the SHA of the git commit of the release, for example: `sha-88a7ff17a3435ec33c95c0323b8f05d7b9f3f6d2-python3.12`
4.  For users that want to be on the latest `3.0.x` release, receiving patch updates, we update a tag without the patch version to this release, for example: `prefect.3.0-python3.12`.
5.  For users that want to be on the latest `3.x.y` release, receiving minor version updates, we update a tag without the minor or patch version to this release, for example: `prefect.3-python3.12`
6.  Finally, for users who want the latest `3.x.y` release without specifying a Python version, we update `3-latest` to the image for our highest supported Python version, which in this case would be equivalent to `prefect:3.0.0-python3.12`.
...
Use care when employing images that automatically update to new versions, such as `prefecthq/prefect:3-python3.11` or `prefecthq/prefect:3-latest`.
</Tip>

### Standard Python

Standard Python images are based on the official Python `slim` images, for example: `python:3.12-slim`.


|Tag                  |Prefect Version            |Python Version|
|---------------------|---------------------------|--------------|
|3-latest             |most recent v3 PyPi version|3.12          |
|3-python3.12         |most recent v3 PyPi version|3.12          |
|3-python3.11         |most recent v3 PyPi version|3.11          |
|3-python3.10         |most recent v3 PyPi version|3.10          |
|3-python3.9          |most recent v3 PyPi version|3.9           |
|3.X-python3.12       |3.X                        |3.12          |
|3.X-python3.11       |3.X                        |3.11          |
|3.X-python3.10       |3.X                        |3.10          |
|3.X-python3.9        |3.X                        |3.9           |
...
|Tag                         |Prefect Version             |Python Version|
|----------------------------|----------------------------|--------------|
|3-latest-conda              |most recent v3 PyPi version |3.12          |
